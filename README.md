...
You can find the [Cloud Palette TOX for TouchDesigner here](https://github.com/SudoMagicCode/td-cloud-palette).
...
[SM Ref Networks](https://github.com/SudoMagicCode/sm-td-ref-networks) | 🌎 Public | A collection of networks built by following along with tutorials |
